...
"background-color: rgb(255, 255, 127);")
        ...
        self.teacherPictureLabel.setGeometry(QRect(560, -10, 201, 191))
        ...
        self.returnCarPushButton.setGeometry(QRect(10, 260, 291, 231))
...
"background-color: rgb(255, 255, 127);")
        ...
        self.readKeyLineEdit.setGeometry(QRect(540, 400, 251, 41))
...
"color: rgb(32, 75, 70);")
        ...
        self.resetPushButton.setGeometry(QRect(10, 260, 291, 231))
        font2 = QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.soundPushButton.setGeometry(QRect(310, 0, 201, 141))
        icon4 = QIcon()
        ...
        self.soundOffPushButton.setGeometry(QRect(310, 0, 201, 141))
        icon5 = QIcon()
...
"color: rgb(0, 0, 0);")
        ...
        self.returnLabel.setGeometry(QRect(10, 260, 291, 231))
...
"color: rgb(0, 0, 0);")
        ...
        self.okButtonLabel.setGeometry(QRect(310, 150, 201, 341))
...
"color: rgb(255, 255, 255);")
        ...
        self.carInfoLabel.setGeometry(QRect(540, 440, 241, 71))
...
"color: rgb(0, 0, 0);")
        ...
        self.inUseCarFrame = QFrame(self.centralwidget)
        self.inUseCarFrame.setObjectName(u"inUseCarFrame")
        self.inUseCarFrame.setGeometry(QRect(810, 380, 531, 321))
        self.inUseCarFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.inUseCarFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.inUseCarLabel = QLabel(self.inUseCarFrame)
        self.inUseCarLabel.setObjectName(u"inUseCarLabel")
        self.inUseCarLabel.setGeometry(QRect(0, 10, 211, 31))
        font3 = QFont()
        font3.setPointSize(12)
        font3.setBold(True)
        self.inUseCarLabel.setFont(font3)
        self.inUseCarLabel.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.inUseInfoPlainTextEdit = QPlainTextEdit(self.inUseCarFrame)
        self.inUseInfoPlainTextEdit.setObjectName(u"inUseInfoPlainTextEdit")
        self.inUseInfoPlainTextEdit.setGeometry(QRect(0, 50, 531, 271))
        self.inUseInfoPlainTextEdit.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.inUseInfoPlainTextEdit.setReadOnly(True)
        self.availableCarFrame = QFrame(self.centralwidget)
        self.availableCarFrame.setObjectName(u"availableCarFrame")
        self.availableCarFrame.setGeometry(QRect(810, 50, 531, 311))
        self.availableCarFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.availableCarFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.freeCarLabel = QLabel(self.availableCarFrame)
        self.freeCarLabel.setObjectName(u"freeCarLabel")
        self.freeCarLabel.setGeometry(QRect(0, 10, 211, 31))
        self.freeCarLabel.setFont(font3)
        self.freeCarLabel.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.freeCarInfoPlainTextEdit = QPlainTextEdit(self.availableCarFrame)
        self.freeCarInfoPlainTextEdit.setObjectName(u"freeCarInfoPlainTextEdit")
        self.freeCarInfoPlainTextEdit.setGeometry(QRect(0, 40, 531, 271))
        self.freeCarInfoPlainTextEdit.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.freeCarInfoPlainTextEdit.setReadOnly(True)
...
"color: rgb(255, 255, 255);")
        ...
        self.returnCarPushButton.clicked.connect(self.takeCarPushButton.hide)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.inUseCarLabel.setText(QCoreApplication.translate("MainWindow", u"AJOSSA:", None))
