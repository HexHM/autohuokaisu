<<<<<<< HEAD:SQL/createTables.sql
-- Luo autolainaustietojen mallin
=======
-- Luo autolainaustietokannan taulut ja laskurit
>>>>>>> 2aaafdbccbf5349c7bc258c94945c36a18cc16b0:BackUps/createTables.sql
...
<<<<<<< HEAD:SQL/createTables.sql
COMMENT ON COLUMN ryhma.ryhma IS 'Ryhm�n nimi, esim. auto22B tai henkilokunta';
COMMENT ON COLUMN ryhma.vastuuhenkilo IS 'Vastuuopettaja tai lahiesimies';
=======
...
<<<<<<< HEAD:SQL/createTables.sql
COMMENT ON COLUMN lainaaja.sahkoposti IS 'Rasekon sahkopostiosoite';
COMMENT ON COLUMN lainaaja.ryhma IS 'Ryhman nimi, esim. auto22B tai henkilokunta';
=======
...
<<<<<<< HEAD:SQL/createTables.sql
COMMENT ON COLUMN lainaus.lainausaika IS 'Paivamaara ja kellonaika, kun auto on otettu lainaan';
COMMENT ON COLUMN lainaus.palautus IS 'Palautuksen paiva ja kellonaika';
=======
