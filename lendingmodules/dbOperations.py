#<<<<<<<< HEAD:lendingmodules/dbOperations.py
"""A module to connect to a PostgresSQL database and do basic CRUD-operations (Create, Read, Update and Delete)     
"""

#========
"""A module to connect to a PostgreSQL database and do basic CRUD-operations (Create, Read, Update and Delete)
"""
#>>>>>>>> 28ff53a7fcf174215a7e8b0a63f0d7ba81b9e843:lendingModules/dbOperations.py
...
class DbConnection():
    ...
    def filterColumsFromTable(self, table: str, columns: list, filter:str) -> list:
            ...
            Args:
                ...
                filter (str): SQL code for WHERE clause

            Raises:
                e: an errir nessage geberated by driver or database
